...
public class BusinessMenu extends Activity {
	...
	protected void onCreate(Bundle paramBundle)
	{
		...
		"The Business Listings in Denim Business Directory are grouped under the various value chain segments for easier and quicker reference. Please click on any of the segments below to explore the companies listed in that segment."));
		l.setOnItemClickListener(new AdapterView.OnItemClickListener()
		{
			public void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
			{
				...
				Intent localIntent = new Intent(getApplicationContext(),BusinessCompanyList.class);
				

				localIntent.putExtra("id",segId.get(paramAnonymousInt) );
	...
	private class HttpAsyncTask extends AsyncTask<String, Void, String>{
		...
		protected void onPreExecute() {
			...
			PD = new ProgressDialog(BusinessMenu.this);
		...
		protected void onPostExecute(String result) {
			...
			PD.dismiss();
			localArrayAdapter = new ArrayAdapter<String>(BusinessMenu.this,  android.R.layout.simple_list_item_1, BusinessSegments);
